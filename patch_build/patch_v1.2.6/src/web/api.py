    ...
    try:
        ...
        query = '''
            SELECT
                ...
                (SELECT status FROM board_projects
                 WHERE ship_name = wr.ship_name ORDER BY id DESC LIMIT 1) as board_status
...
def import_excel_data(base64_data: str, username: str = 'admin') -> Dict[str, Any]:
    ...
    try:
        ...
        if is_xls:
            ...
            rows_raw = [ws_xls.row_values(i) for i in range(ws_xls.nrows)]
