; InnoSetup 설치 스크립트
; 금일작업현황 관리 앱 - Embedded Python 배포
...
OutputBaseFilename=WorkManagement_Setup_v2.2.36
...
[Icons]
; 시작 메뉴
Name: "{group}\금일작업현황 관리"; Filename: "{app}\python\pythonw.exe"; Parameters: """{app}\app\src\main.py"""; WorkingDir: "{app}"; IconFilename: "{app}\app\assets\icon.ico"; Comment: "금일작업현황 관리 앱"
Name: "{group}\제거"; Filename: "{uninstallexe}"

; 바탕화면 (선택)
Name: "{autodesktop}\금일작업현황 관리"; Filename: "{app}\python\pythonw.exe"; Parameters: """{app}\app\src\main.py"""; WorkingDir: "{app}"; IconFilename: "{app}\app\assets\icon.ico"; Tasks: desktopicon; Comment: "금일작업현황 관리 앱"
